...
import { retrieveProjectDetails, retrieveDonorsByProject,confirm,retrieveConfirmation } from "../../services/axios_api";
...
class ProjectCharity extends Component{
    ...
    componentDidMount(){
        ...
        retrieveProjectDetails(this.state.project_id).then(response =>{
          ...
          retrieveConfirmation(this.state.project_id).then(response=>{
            this.setState({
    ...
    render(){
        return(
            <div style={{height:"100%"}}>
                    ...
                    <Row style={{width:"95%", alignContent:"center"}}>
                        <Col xs="40" sm="12" md="8">
                            ...
                            <h2>
                                ...
                                <Card>
                                    <CardHeader>
                                        <i className="fa fa-align-justify"></i> Confirmations <small className="text-muted">latest 10 donors</small>
                                    </CardHeader>
                                    <CardBody>
                                        <Table responsive hover className="table table-striped">
                                        <thead>
                        ...
                        <Col xs="12" sm="12" md="4" >
                            ...
                            <div >
                                ...
                                <Button block color="primary" onClick={this.togglePrimary}>Make Confirmation</Button>
                            </div>
                            ...
                            />
                                    ...
                                    <ListGroup className="mt-3">
                                        <ListGroupItemHeading><h2>Contact Information</h2></ListGroupItemHeading>
                ...
                <ModalBody>
                    ...
                    <h4>Confirmation</h4>
                        <FormGroup row>
                            ...
                            <Col xs="12" md="9">
                                <Input type="number" id="disabled-input" name="disabled-input"  onChange={this.updateValue("amount")} />
                            </Col>
                        </FormGroup>
                        <FormGroup row>
                            <Col md="3">
                            ...
                            <Col xs="12" md="9">
                                <Input type="textarea" name="textarea-input" id="textarea-input" rows="9"
                                        placeholder="Content..." onChange={this.updateValue("description")}/>
                            </Col>
                        </FormGroup>
                    </div>
                ...
                <ModalFooter>
                    <Button className={this.state.confirmationFinished?'hidden':''} color="primary" onClick={this.confirm}>Confirm!</Button>
